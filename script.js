document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        try {
            ...
            addMessageToChat(ASSISTANT_NAME, "Oops! Looks like I need to file some more paperwork! Please try again and I'll make sure to process your request properly next time!", getCurrentTime()); // Use ASSISTANT_NAME
        }
    }
